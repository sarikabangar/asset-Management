...
public class AccountsControllerTest {
  ...
  public void getAccount() throws Exception {
    ...
    this.mockMvc.perform(get("/v1/accounts/" + uniqueAccountId))
      ...
      .andExpect(
        content().string("{\"accountId\":\"" + uniqueAccountId + "\",\"balance\":123.45,\"accountLock\":{\"queueLength\":0,\"fair\":false,\"readHoldCount\":0,\"readLockCount\":0,\"writeHoldCount\":0,\"writeLocked\":false,\"writeLockedByCurrentThread\":false}}"));
  ...
  public void transferMoney() throws Exception {
    ...
    this.mockMvc.perform(get("/v1/accounts//wire-transfer"))
      .andExpect(status().isOk())
      .andExpect(
        content().string("Money Transfer was successful"));
  }
}
